...
const suppliers = [
  ...
  {
    id: 3,
    name: "TechMill Industries",
    type: "Manufacturer",
    location: "Lagos, Nigeria",
    products: ["Flour Mills", "Processing Equipment", "Industrial Machinery"],
    rating: 4.7,
    reviews: 89,
    yearsOnPlatform: 6,
    verified: true,
  ...
  {
    id: 5,
    name: "Zambia Mining Co",
    type: "Mining Company",
    location: "Lusaka, Zambia",
    products: ["Copper Cathodes", "Cobalt", "Precious Metals"],
    rating: 4.9,
    reviews: 67,
    yearsOnPlatform: 12,
    verified: true,
  ...
  {
    id: 6,
    name: "Ghana Natural Products",
    type: "Exporter",
    location: "Accra, Ghana",
    products: ["Shea Butter", "Cocoa Butter", "Natural Oils"],
    rating: 4.8,
    reviews: 189,
    yearsOnPlatform: 7,
    verified: true,
